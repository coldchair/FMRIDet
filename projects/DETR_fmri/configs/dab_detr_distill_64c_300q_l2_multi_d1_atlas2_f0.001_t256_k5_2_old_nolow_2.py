...
# 可视化阈值
default_hooks = dict(
    visualization=dict(score_thr = 0.20))
...
model = dict(
    type='DABDETR_distill_new_old',
    teacher_cfg = teacher_config,
    student_cfg = student_config,
    loss_feature_distill_alpha = 0,
    loss_encoded_feature_distill_alpha = 60,
    loss_label_alpha = 0,
    teacher_dim = 256,
    student_dim = 64,
...
# load_from = '/home/bingxing2/ailab/scx7kzd/denghan/FMRIDet/workdirs/dab_detr_distill_64c_300q_l2_multi_d1_atlas2_f0.001_t256_k5_2/epoch_30.pth'