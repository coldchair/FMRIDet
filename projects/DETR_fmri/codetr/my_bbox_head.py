...
class DABDETRHead_distill(DABDETRHead):
    ...
    def loss_by_feat_single_distill(self,
                            ...
                            cls_scores_t: Tensor, bbox_preds_t: Tensor,
                            batch_gt_instances: InstanceList,
                            batch_img_metas: List[dict]) -> Tuple[Tensor]:
        # ------------ modify batch_gt_instances to teacher model's output ----------- #
        batch_gt_instances = [
            InstanceData(metainfo=batch_gt_instances[i].metainfo,
                        bboxes=bbox_preds_t[i],
                        labels=cls_scores_t[i])
        ...
        cls_reg_targets = self.get_targets_distill(cls_scores_list, bbox_preds_list,
        ...
        loss_iou = self.loss_iou_distill(
        ...
        # print(f'loss_cls: {loss_cls}, loss_bbox: {loss_bbox}, loss_iou: {loss_iou}')
        # print(loss_cls, loss_bbox, loss_iou)
