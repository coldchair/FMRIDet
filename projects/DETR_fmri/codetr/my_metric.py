...
class CocoMetric_modified(CocoMetric):
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        # gts : width, height, img_id
        # preds : a turple of pred
        # pred : dic, 'img_id', 'bboxes', 'scores', 'labels'
        # print(gts)
        # print('---------------')
        # print(preds) 
        ...
        if self.img_ids is None:
            ...
            # we don't use all the img_id to test, because train and test share a ann file.
            # we only use img_id that appear in the preds
            img_ids = []
            for dic in preds:
                img_ids.append(dic['img_id'])
        ...
        for metric in self.metrics:
            ...
            # print(self.cat_ids) # [1 - 90]
            # print(self.img_ids) # old : [0-72999], new : [img_id in test_dataset]
            # print(self.proposal_nums) # [100, 300, 1000]
            # print(self.iou_thrs) # [0.5  0.55 0.6  0.65 0.7  0.75 0.8  0.85 0.9  0.95]
