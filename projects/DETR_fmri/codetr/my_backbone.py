...
from .my_base_modules import PositionalEncoding, TransformerPredictor

# 暂时跑不起来，显存不够
@MODELS.register_module()
class Backbone_fmri_transformer(BaseModule):
    def __init__(self, output_dim = (256, 25, 25), feature_dim = 7800, num_layers = 2, num_heads = 4, hidden_dim = 2048, **kwargs):
        ...
        self.transformer = TransformerPredictor(self.feature_dim, self.num_layers, self.num_heads, self.hidden_dim, self.output_dim[0]*self.output_dim[1]*self.output_dim[2])
    def forward(self, x):
